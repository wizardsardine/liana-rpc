...
from liana_rpc.liana_rpc import LianaRPC, get_liana_instances, psbt_to_txid, rawtx_to_txid
...
def test_fetch_tx(liana):
    ...
    txid = rawtx_to_txid(tx)
    tx2 = liana.fetch_tx(txid)['tx']
    txid2 = rawtx_to_txid(tx2)
    assert txid == txid2
